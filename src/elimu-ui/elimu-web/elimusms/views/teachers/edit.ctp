...
<div id="content">
	...
	<?php echo $this->Form->create('Teacher');?>
		...
		<?php
			echo $this->Form->input('TeacherID',array('type'=>'hidden'));
...
<div id="column"></div>
	<div class="actions">
		...
		<ul>
			...
			<li><?php echo $this->Html->link(__('View My Profile', true), array('action' => 'view', $this->Form->value('Teacher.TeacherID')));?></li>
			<li><?php echo $this->Html->link(__('View Other Teachers', true), array('action' => 'index'));?></li>
			<li><?php echo $this->Html->link(__('View My Current School', true), array('controller' => 'schools', 'action' => 'view',$this->Form->value('Teacher.TeacherID') )); ?> </li>
			<li><?php echo $this->Html->link(__('Add A Class', true), array('controller' => 'courses', 'action' => 'add')); ?> </li>
			<li><?php echo $this->Html->link(__('View My Classes', true), array('controller' => 'courses', 'action' => 'list_teacher_classes',$this->Form->value('Teacher.TeacherID'))); ?> </li>
			<li><?php echo $this->Html->link(__('View My Students', true), array('controller' => 'students', 'action' => 'list_teacher_students',$this->Form->value('Teacher.TeacherID'))); ?> </li>
			<li><?php echo $this->Html->link(__('Delete My Profile', true), array('action' => 'delete', $this->Form->value('Teacher.TeacherID')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Teacher.TeacherID'))); ?></li>
